...
public static partial class ResultExtensions
{
    ...
    public static async Task<Result<TValue>> CheckAsync<TValue>(this Task<Result<TValue>> resultTask, Func<Result> check)
    {
        ArgumentNullException.ThrowIfNull(check);
    ...
    /// <returns>A Task containing the original Result when successful, otherwise a failed Result with the check errors.</returns>
    public static async Task<Result<TValue>> CheckAsync<TValue>(this Task<Result<TValue>> resultTask, Func<TValue, Result> check)
    {
        ArgumentNullException.ThrowIfNull(check);
