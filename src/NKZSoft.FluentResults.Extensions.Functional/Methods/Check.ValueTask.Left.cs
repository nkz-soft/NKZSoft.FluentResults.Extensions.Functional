...
public static partial class ResultExtensions
{
    ...
    public static async ValueTask<Result<TValue>> CheckAsync<TValue>(this ValueTask<Result<TValue>> resultTask, Func<Result> check)
    {
        ArgumentNullException.ThrowIfNull(check);
    ...
    /// <returns>A ValueTask containing the original Result when successful, otherwise a failed Result with the check errors.</returns>
    public static async ValueTask<Result<TValue>> CheckAsync<TValue>(this ValueTask<Result<TValue>> resultTask, Func<TValue, Result> check)
    {
        ArgumentNullException.ThrowIfNull(check);
