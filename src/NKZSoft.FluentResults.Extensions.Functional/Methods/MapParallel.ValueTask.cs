...
{
    /// <summary>
    /// Maps source values to result values in parallel using value-task-based delegates.
    /// </summary>
    ...
    /// <param name="map">ValueTask-based mapper that returns a result per value.</param>
